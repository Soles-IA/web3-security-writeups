...
| WOOFi Swap | Sherlock, Sep 2024 ($21.5K) — shadow audit | Independent re-audit: confirmed High (rebate_manager create front-running -> fee theft) matching Lead Senior Watson "g"'s validated finding; 3 candidates dismissed with rationale (incl. same-pattern wooracle case, contained downstream) | [link](https://github.com/Soles-IA/web3-security-writeups/tree/main/solana/woofi) |
